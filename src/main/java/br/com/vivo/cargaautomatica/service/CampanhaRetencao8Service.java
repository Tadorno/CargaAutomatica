 ...
 * @author tadorno
 */
public class CampanhaRetencao8Service extends CampanhaService<CampanhaGenerica>{
    ...
    public String getPathOrigem(){
        return PropertySingleton.getProperty("file-crm_ret_8-origem-path");
    }
    
    @Override
    public String getPathDestino(){
        return PropertySingleton.getProperty("file-crm_ret_8-local-path");
    }
    
    @Override
    public String getFileName(){
        return PropertySingleton.getProperty("file-crm_ret_8-name");
    }
